...
interface ProductItemProps {
  ...
  const Detailed_carousel = ({ item }: { item: ProductItemProps})=> {
  ...
  return (
    <View style={{ height: '100%', width: '100%' }}>
      <ScrollView style={{ height: 100, width: '100%' }}>
        <View style={[styles.root, { height: 300 }]}>
    ...
    <View style = {[styles.descrp_container, { height:180 , top : '4%'}]}>
      <View style = {{flexDirection : 'column'}}>
        ...
        <AntDesign name = "bank" size = {25} color = '#50e848'/>
        ...
        <Text style = {{ marginHorizontal : '4%' , color : '#50e848'}}> T&C</Text>
        </View>
        </View>
...
export default Detailed_carousel;
